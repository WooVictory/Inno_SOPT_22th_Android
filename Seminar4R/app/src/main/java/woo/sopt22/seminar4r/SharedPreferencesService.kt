...
class SharedPreferencesService {
    ...
    companion object {
        ...
        @Volatile private var sharedPreferencesManager: SharedPreferencesService? = null

        val instance: SharedPreferencesService?
            get() {
                if (sharedPreferencesManager == null) {
                    synchronized(SharedPreferencesService::class.java) {
                        if (sharedPreferencesManager == null)
                            sharedPreferencesManager = SharedPreferencesService()
                    }
                }
